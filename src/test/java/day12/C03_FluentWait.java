...
public class C03_FluentWait extends TestBase {
    ...
    public void fluentWaitTest(){
        ...
        //1. Fluent wait icin bir obje olustur. (explicit waitten farkli kisim)
        Wait<WebDriver> wait = new FluentWait<>(driver).
                withTimeout(Duration.ofSeconds(30)).//max bekleme suresi
                        pollingEvery(Duration.ofSeconds(3)).//deneme araliklari
                        withMessage("IGNORE EXCEPTION").//opsiyonel olarak mesaj yazdirabilirim
                        ignoring(NoSuchMethodException.class);//eger elemani bulamazsa exceptioni handle eder.
